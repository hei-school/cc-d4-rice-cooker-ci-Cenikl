...
require_relative 'Exception/lid_is_closed'
require_relative 'Exception/timer_is_on'
...
module Main
  class RiceCooker
    ...
    def put_rice_in_storage
      ...
      begin
        raise LidIsClosed if @lid_closed
